      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs text-slate-500">Public Healthcare Access Initiative</span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6 text-xs text-slate-600">
            ...
            <Link href="/citizen" className="hover:text-teal-800 transition-colors">
              Citizen Portal
            </Link>
        ...
        <div className="mt-6 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between text-[11px] text-slate-400 gap-2">
          ...
          <p>Privacy-first • Data is evaluated solely for eligible healthcare entitlement support.</p>
        </div>
      </div>
    </footer>
  );
